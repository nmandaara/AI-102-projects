...
def main():
    try:
        ...
        # Get Classifications
        operation = text_client.begin_single_label_classify(
            batchedDocuments,
        ...
        for doc, classification_result in zip(files, document_results):
            if classification_result.kind == "CustomDocumentClassification":
                ...
                print("{} was classified as {} with a confidence score {}.".format(doc, classification.category, classification.confidence_score))
